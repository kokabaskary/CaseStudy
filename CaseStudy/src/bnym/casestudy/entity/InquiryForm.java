...
public class InquiryForm {
	...
	//Constructor=====================================================================
			...
			public InquiryForm(CakeSize cakeSize, CakeFrosting cakeFrosting,
			...
			public InquiryCustomer getInquiryCustomer() {
			...
			public void setInquiryCustomer(InquiryCustomer inquiryCustomer) {
				this.inquiryCustomer = inquiryCustomer;
			}
